...
public class MPGenerator {
	...
	public void  Generator() {
		...
		dsConfig.setDbType(DbType.MYSQL)  // 设置数据库类型
				...
				.setUrl("jdbc:mysql://129.226.114.98:3306/numberone?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&failOverReadOnly=false&useSSL=false&serverTimezone=CTT")
				.setUsername("root")
				.setPassword("123456");
		...
		pkConfig.setParent("com.app.mdc")
				...
				.setController("controller.system")
